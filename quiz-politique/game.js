...
function buildQuiestceRound(niveau) {
    ...
    for (const target of targets) {
        ...
        // Si le vivier du même sexe est trop petit (typiquement le niveau
        // "présidentielle", encore peu peuplé), complète avec l'autre sexe
        // plutôt que d'abandonner la cible.
